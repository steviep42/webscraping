...
- book.bib
- packages.bib
description: This is in support of my talk for the Data Scidence group
documentclass: book
link-citations: yes
...
There are a number of tools that allow us to inspect web pages and see "what is under the hood"
